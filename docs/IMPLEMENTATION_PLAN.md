...
| 赛车专项定时 | 已实现增强版 | 当前支持禁发提醒、智能发车、夜间收车提醒、收车；定时智能发车已切到独立 sidecar 新逻辑 |
...
| `/xyzw 赛车` | 查看车辆概览/护卫成员状态/执行发车/收车/智能发车 | 已实现增强版（支持 `/xyzw 赛车 护卫成员 ...`、`/xyzw 赛车 智能发车`、`/xyzw 赛车 智能发车 白名单 查看|设置|清空`） |
...
| `/xyzw 定时 ...` | 任务增删改查 | 已实现增强版（当前支持挂机提醒、定时日常、定时答题、活动开放提醒、定时资源/副本执行、赛车专项定时） |
...
| `M3` | 定时提醒、定时日常、执行报告 | 进行中（已落地挂机提醒基础版、定时日常基础版、定时资源/副本执行基础版与活动开放提醒基础版） |
| `M4` | 批量执行、更多高级任务 | 待做 |
